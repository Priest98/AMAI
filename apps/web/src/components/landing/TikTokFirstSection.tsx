 ...
 * distinct from the Hero/Features copy: it's the strategic-positioning
...
export default function TikTokFirstSection() {
  return (
    <section id="tiktok-first" className="relative py-16 sm:py-20" aria-label="TikTok first">
      <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
        <Reveal>
          ...
          <p className="mt-5 text-base sm:text-lg leading-relaxed" style={{ color: 'var(--lp-text-secondary)' }}>
            ...
            fully supported, end to end -- with more platforms on the roadmap.
          </p>
        </Reveal>
      </div>
    </section>
