		...
		<div className="relative mx-auto grid max-w-4xl grid-cols-1 gap-8 md:grid-cols-2 md:items-center rounded-xl exec-card p-6 my-6 overflow-hidden">
				...
				<div className="space-y-2">
					...
					<p className="text-xs md:text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
						{INSTAGRAM_ENABLED
							...
							: 'TikTok powers the Oyinca AutoPilot engine for automated publishing. Connecting a Google Drive folder for media sync lives in the Media Library.'}
					</p>
				</div>
			</div>
			...
			<div className="flex items-center justify-center md:justify-end p-4">
				<div className="flex items-center space-x-4">
					...
					{/* Instagram -- hidden for now (see lib/featureFlags.ts) */}
					{INSTAGRAM_ENABLED && (
						<div className="flex flex-col items-center space-y-2 group">
							<div className="h-16 w-16 rounded-xl bg-white dark:bg-zinc-900 border flex items-center justify-center p-3.5 shadow-lg group-hover:scale-105 transition-transform ring-2 ring-blue-500/20" style={{ borderColor: 'var(--card-border)' }}>
