      ...
      >
        ...
        <div className="flex justify-center items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl text-xs font-bold bg-gradient-to-r from-rose-500 to-purple-600 hover:opacity-95 text-white shadow-md transition flex items-center space-x-1.5 touch-target"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl text-xs font-bold bg-slate-200/60 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/20 text-slate-700 dark:text-zinc-200 transition flex items-center space-x-1.5 touch-target"
          >
