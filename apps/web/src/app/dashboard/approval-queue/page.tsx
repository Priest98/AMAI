                ...
                >
                  ...
                  {isEditing ? (
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="flex flex-wrap justify-end gap-2 pt-1">
                        ...
                        <button
                          ...
                          disabled={isBusy}
                          className="px-3 py-2 rounded-lg text-xs font-bold text-blue-600 dark:text-blue-400 border border-blue-500/30 bg-blue-500/10 hover:bg-blue-500/20 flex items-center space-x-1.5 transition disabled:opacity-50"
                        >
                    ...
                    <>
                      ...
                      {post.ctaText && (
                        <p className="text-xs font-semibold text-blue-500">{post.ctaText}</p>
                      )}
